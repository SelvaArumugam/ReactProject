...
export default function SignUpPage()
{
    return(
        <div  style={{backgroundColor:"gray",height:"100vh" ,display:"flex", justifyContent:"center",alignItems:"center"}}>
            <Paper style={{alignItems:"center"}} variant='elevation' square={false} sx={{height:"600px",width:"700px", display: "flex",flexDirection:"column"}}>
                <Typography variant="h4" sx={{mt:5,mb:5,color:"darkorange"}}>SignUp to BookMyFlight</Typography>
                <div>
                    <TextField label="First Name" style={{paddingRight:4}} color="warning"></TextField>
                    <TextField label="Last Name" color="warning"></TextField>
                </div>
                <TextField  color='warning' sx={{mt:5 , mb:5 ,width: 400, maxWidth: '100%',}}  label="Enter phone number" type={"tel"} 
                    InputProps={{startAdornment: <InputAdornment position="start">+91</InputAdornment>,
                    }}></TextField>
                <TextField color='warning' sx={{ mb:5,width: 400, maxWidth: '100%',}} label="Enter email" type={"email"} ></TextField>
